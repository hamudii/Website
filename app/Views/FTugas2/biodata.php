...
<html lang="en">
    <head>
        ...
        <style>
            .box-shadow {
                box-shadow: 17px 18px 11px -12px rgba(0, 0, 0, 0.41);
                -webkit-box-shadow: 17px 18px 11px -12px rgba(0, 0, 0, 0.41);
                -moz-box-shadow: 17px 18px 11px -12px rgba(0, 0, 0, 0.41);
            }
            ...
            <div class="accordion" id="accordionExample">
                <div class="copy-container">
                    ...
                    <div class="img-container">
                        <img class="box-shadow" src="https://media.suara.com/pictures/653x366/2020/03/02/39467-cristiano-ronaldo-berseragam-real-madrid.jpg" alt= "" width="653" height="366">
                    </div>
